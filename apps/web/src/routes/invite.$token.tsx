...
import {
	type AcknowledgeWitnessMutation,
	type AcknowledgeWitnessMutationVariables,
	type GetWitnessInvitationQuery,
	type GetWitnessInvitationQueryVariables,
	WitnessStatus,
...
const GET_WITNESS_INVITATION: TypedDocumentNode<
...
const ACKNOWLEDGE_WITNESS: TypedDocumentNode<
	AcknowledgeWitnessMutation,
	AcknowledgeWitnessMutationVariables
> = gql`
  mutation AcknowledgeWitness($input: AcknowledgeWitnessInput!) {
...
function InviteComponent() {
	...
	const {
		...
		loading,
		error: queryError,
	} = useQuery(GET_WITNESS_INVITATION, {
		variables: { token },
	});
	...
	if (queryError || !data?.witnessInvitation) {
		return (
			<div className="flex min-h-screen items-center justify-center bg-neutral-50 dark:bg-neutral-950">
