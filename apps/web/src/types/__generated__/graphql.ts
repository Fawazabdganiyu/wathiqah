...
export type GetContactsQuery = { contacts: Array<{ __typename: 'Contact', id: string, name: string, email: string | null, phoneNumber: string | null, balance: number, createdAt: unknown }> };
...
export type GetContactQuery = { contact: { __typename: 'Contact', id: string, name: string, email: string | null, phoneNumber: string | null, balance: number, createdAt: unknown } };
...
export type MyPromisesQuery = { myPromises: Array<{ __typename: 'Promise', id: string, description: string, promiseTo: string, dueDate: unknown, priority: Priority, status: PromiseStatus, category: string | null, notes: string | null, createdAt: unknown, updatedAt: unknown }> };
...
export type CreatePromiseMutation = { createPromise: { __typename: 'Promise', id: string, description: string, promiseTo: string, dueDate: unknown, priority: Priority, status: PromiseStatus } };
...
export type MyAccessGrantsQuery = { myAccessGrants: Array<{ __typename: 'AccessGrant', id: string, email: string, token: string, status: AccessStatus, createdAt: unknown, expiresAt: unknown | null }> };
...
export type ReceivedAccessGrantsQuery = { receivedAccessGrants: Array<{ __typename: 'AccessGrant', id: string, email: string, token: string, status: AccessStatus, createdAt: unknown, granter: { __typename: 'User', id: string, firstName: string, lastName: string, email: string } | null }> };
...
export type SharedDataQuery = { sharedData: { __typename: 'SharedDataEntity', user: { __typename: 'User', id: string, firstName: string, lastName: string, email: string }, transactions: Array<{ __typename: 'Transaction', id: string, amount: number | null, type: TransactionType, date: unknown, description: string | null, category: AssetCategory, itemName: string | null, quantity: number | null, contact: { __typename: 'Contact', name: string } | null, witnesses: Array<{ __typename: 'Witness', id: string, status: WitnessStatus, user: { __typename: 'User', name: string } } | null> }>, promises: Array<{ __typename: 'Promise', id: string, description: string, promiseTo: string, dueDate: unknown, priority: Priority, status: PromiseStatus, notes: string | null }> } };
...
export type TransactionQuery = { transaction: { __typename: 'Transaction', id: string, amount: number | null, category: AssetCategory, type: TransactionType, date: unknown, description: string | null, itemName: string | null, quantity: number | null, createdAt: unknown, contact: { __typename: 'Contact', id: string, name: string } | null, witnesses: Array<{ __typename: 'Witness', id: string, status: WitnessStatus, invitedAt: unknown, acknowledgedAt: unknown | null, user: { __typename: 'User', id: string, name: string, email: string } } | null>, history: Array<{ __typename: 'TransactionHistory', id: string, changeType: string, previousState: unknown, newState: unknown, createdAt: unknown, user: { __typename: 'User', id: string, name: string, email: string } } | null> } };
...
export type CreateTransactionMutation = { createTransaction: { __typename: 'Transaction', id: string, amount: number | null, type: TransactionType, description: string | null, date: unknown } };
...
export type AddWitnessMutation = { addWitness: { __typename: 'Transaction', id: string, witnesses: Array<{ __typename: 'Witness', id: string, status: WitnessStatus, invitedAt: unknown, user: { __typename: 'User', id: string, name: string, email: string } } | null> } };
...
export type MyWitnessRequestsQuery = { myWitnessRequests: Array<{ __typename: 'Witness', id: string, status: WitnessStatus, invitedAt: unknown, acknowledgedAt: unknown | null, transaction: { __typename: 'Transaction', id: string, amount: number | null, type: TransactionType, description: string | null, date: unknown, createdBy: { __typename: 'User', name: string, email: string } } }> };
...
export type AcknowledgeWitnessRequestMutation = { acknowledgeWitness: { __typename: 'Witness', id: string, status: WitnessStatus, acknowledgedAt: unknown | null } };
...
export type GetWitnessInvitationQuery = { witnessInvitation: { __typename: 'Witness', id: string, status: WitnessStatus, transaction: { __typename: 'Transaction', id: string, amount: number | null, type: TransactionType, description: string | null, date: unknown, createdBy: { __typename: 'User', name: string } }, user: { __typename: 'User', id: string, email: string, name: string, passwordHash: string | null } } };
