      ...
      <div className="flex flex-col md:flex-row justify-between gap-4">
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <span className="font-semibold text-lg">{transaction.createdBy.name}</span>
            <span className="text-muted-foreground text-sm">requested your witness</span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-x-8 gap-y-1 text-sm">
            ...
            <span>{format(new Date(transaction.date as string), "MMM d, yyyy")}</span>
